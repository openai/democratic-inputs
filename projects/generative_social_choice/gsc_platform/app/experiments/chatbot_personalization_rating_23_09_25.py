...
text = markdown.markdown(
    """
In the following, we will ask you about your opinion about four different statements regarding chatbot personalization. 

*This is the last and most important part of the survey. We will reward particularly thoughtful answers with a bonus of $1 per statement.*
""")
questions += [ReadingQuestion(len(questions) + 1, text, "Continue")]
...
def create_chatbot_personalization_rating_23_09_25(*,
           name,
