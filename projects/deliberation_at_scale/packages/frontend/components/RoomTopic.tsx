...
export default function RoomTopic({ variant }: TopicProps) {
    ...
    return (
        <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className={classNames("rounded gap-1 md:gap-4 flex flex-col md:flex-row items-center", topicColorBgMap[theme], variant === 'compact' && 'md:mx-4 md:my-2 mb-1 p-2 md:p-4', variant === "spacious" && "p-4")}
        >
